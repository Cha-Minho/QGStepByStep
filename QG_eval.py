...
eval_result_output = args.eval_result_output
...
# gold_file = output_prefix + "paraphrase_gold.txt"
# pred_file = output_prefix + "paraphrase_pred.txt"
...
for d in data_to_write:
    fgold.write(d["qas"][0]["original_question"].replace("\n", "") + "\n")
    fpred.write(d["qas"][0]["question"].replace("\n", "") + "\n")
fgold.close()
fpred.close()
