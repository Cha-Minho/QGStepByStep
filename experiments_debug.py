...
os.system(
    'python3 /home/team5/QGStepByStep/DA_main.py \
        --da_task squad2sentences \
        --da_input_type squad \
        --da_input_file /home/team5/QGStepByStep/Datasets/original/SQuAD1.1-Zhou/train.txt \
        --da_sentences_file /home/team5/QGStepByStep/Datasets/processed/SQuAD1.1-Zhou/train.sentences.txt \
        --da_paragraphs_file /home/team5/QGStepByStep/Datasets/processed/SQuAD1.1-Zhou/train.paragraphs.txt \
        --debug')
...
print("*"*80)
os.system(
    'python3 /home/team5/QGStepByStep/QG_main.py \
        --mode train \
        --batch_size 2 \
        --epochs 2 \
        --copy_type hard-oov \
