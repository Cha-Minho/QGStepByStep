...
output_path="/home/team5/QGStepByStep/Datasets/output/QG/generated/hotpot_comp1_simple/"
data_file_prefix="simplified_text"
st_idx=0
ed_idx=1000
epochs=10
...
CUDA_VISIBLE_DEVICES=0 PYTHONIOENCODING=utf-8 python3 QG_gpt2_generate.py  \
    --model_type gpt2 \
    --model_name_or_path "/home/team5/QGStepByStep/Datasets/output/QG/sub_models/" \
    --filename "/home/team5/QGStepByStep/DCQG_data/${data_file_prefix}.json" \
    --data_type $experiment \
    --output_file "$output_path${data_file_prefix}.${st_idx}.${ed_idx}.generated.gpt2_simple.json" \
    --calc_tg_metrics\
    #--subq_dir "/home/team5/QGStepByStep/Datasets/output/QG/generated/hotpot_sub/${data_file_prefix}.${st_idx}.${ed_idx}.generated.gpt2_paraphrased.intermediate.json" \
